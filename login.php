    ...
    <div class="login-container">
        ...
        <form method="post">
            <div class="mb-3 text-start">
                <label for="user" class="form-label">LRN</label>
                <input name="user" class="form-control" required oninput="this.value = this.value.replace(/[^0-9]/g, '')">
            </div>
            <div class="mb-3 text-start">
            ...
            <div class="mt-3 extra-links">
                ...
                <p>Not student? <a href="teacher_login.php">Teacher Login</a></p>
            </div>
        </form>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "SELECT * FROM users WHERE Username = ? AND User_role = 'Student'";
